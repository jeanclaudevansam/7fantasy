<script>
    ...
    let one, oneOne, oneOneOne, oneTwo, oneTwoOne, oneTwoTwo, oneTwoThree, oneTwoFour, oneTwoFive;
...
<div class="constitution">
    ...
    <p>2 IR Spots (Player must be labeled as IR, Out, or Covid in the Sleeper App)</p>
        ...
        <div class="subBlock">
            <table class="positionMaximums">
                <tr><td>QB</td><td class="right">1 active, 3 total</td></tr>
                <tr><td>RB</td><td class="right">7</td></tr>
                <tr><td>WR</td><td class="right">8</td></tr>
                <tr><td>TE</td><td class="right">5</td></tr>
                <tr><td>D/ST</td><td class="right">2</td></tr>
                <tr><td>K</td><td class="right">4</td></tr>
            </table>
        </div>
    ...
    <div class="subBlock">
        ...
        <ul>
            ...
            <li>Third Offense – A league meeting of members not involved in any of the improper trades/activity in question will take place to discuss next steps.</li>
        </ul>
    ...
    <div class="subBlock">
        <p>The trade deadline will be set for EoD on Tuesday of the week 11 games of the NFL season.</p>
    </div>
    
    <h4 bind:this={oneTwoFour}>1.2.4 Trade Restrictions</h4>
    <div class="subBlock">
        <p>You will not be able to trade draft picks that are more than 1 draft away. For example, during the 2024 season you cannot trade any picks in or after the 2025 draft.</p>
    </div>
    ...
    <p>The draft order each year will be a snake draft. Subsequent drafts with follow a linear draft pattern determinded by standings of the 2024 season.</p>
    ...
    <p>At the end of the season, 6 teams will make the playoffs. The first round of playoffs will commence in week 15. Each team that wins their division and the 4 wild card teams that finish with the best records, will receive a playoff berth. The 2 teams that win their division will receive a bye week in the first round of the playoffs. Each playoff matchup will only last one week and the winner will advance.</p>
